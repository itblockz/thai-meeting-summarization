...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp45_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp45_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp45/eval_result"
...
echo "=== exp45: Qwen3.6-27B-FP8 (single A100-40GB) + exp38 prompt/shots ==="
cd "$PROJECT/exp45"
python3 run.py

echo "=== exp45: scoring (full 1239, headline — has doc_050 few-shot leak) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp45: leak-free scoring (hold out doc_050, 1218 queries) ==="
