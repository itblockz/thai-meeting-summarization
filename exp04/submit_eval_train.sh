...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp04_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp04_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp04/eval_result"
...
echo "=== exp04: inference on train set ==="
cd "$PROJECT/exp04"
python3 run.py
