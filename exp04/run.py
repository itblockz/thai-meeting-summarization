"""
exp04 — textsum rerank pipeline + Typhoon2.1-Gemma3-12B.

Single change vs exp03: generation LLM is typhoon-ai/typhoon2.1-gemma3-12b
(Thai-tuned, 12B BF16) instead of Qwen3-32B-AWQ. Retrieval is identical,
so the score delta is attributable to the LLM swap alone.
"""
...
MODEL_NAME     = "typhoon-ai/typhoon2.1-gemma3-12b"
...
def main():
    ...
    llm = LLM(model=MODEL_NAME, max_model_len=4096,
              gpu_memory_utilization=0.90, dtype="bfloat16")
