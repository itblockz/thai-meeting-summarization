...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp50_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp50_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp50/eval_result"
...
echo "=== exp50: Qwen3.6-27B-FP8 + V10_factual prompt ==="
cd "$PROJECT/exp50"
python3 run.py

echo "=== exp50: scoring (full 1239, headline — has doc_050 few-shot leak) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp50: leak-free scoring (hold out doc_050, 1218 queries) ==="
