...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp05_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp05_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp05/eval_result"
...
echo "=== exp05: inference on train set ==="
cd "$PROJECT/exp05"
python3 run.py
