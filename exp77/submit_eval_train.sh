...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp77_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp77_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp77/eval_result"
...
echo "=== exp77: scoring (full 1239, headline — has doc_050 few-shot leak) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp77: leak-free scoring (hold out doc_050, 1218 queries) ==="
