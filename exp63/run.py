"""
exp63 — exp40 (Qwen3.6-27B-FP8) + enable_prefix_caching=True.

Single-variable test of exp40: vLLM auto-disabled prefix caching for
the Qwen3_5ForConditionalGeneration (multimodal) arch, so exp40
re-prefilled the ~14K-token doc for all 1239 queries (SLURM 2:01:38
vs AWQ 27:00 / A3B 16:20). Force it back on and measure wall-clock.
Everything else identical to exp40.
...
def main():
    ...
    n = len(queries)
    print(f"exp63: {n} queries, {len(doc_index)} docs "
