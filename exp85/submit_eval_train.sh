...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp85_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp85_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp85/eval_result"
...
echo "=== exp85: S1=gemma -> S2=A3B (hint=answer+ref), emit 4 combos ==="
cd "$PROJECT/exp85"
python3 run.py
