...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp55_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp55_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp55/eval_result"
...
echo "=== exp55: pipeline 1 — exp50 refs filter context, exp38 LLM answer ==="
cd "$PROJECT/exp55"
python3 run.py

echo "=== exp55: scoring (full 1239) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp55: leak-free scoring (excl. doc_050) ==="
