"""
exp13 — exp12 with length-matched examples.

exp12 (doc_002 held-out, examples Q0774+Q0775) gave only +0.0010 composite
vs exp03 baseline on the same subset, with SS-score DROPPING -0.0080 and
predictions running 28 tokens median vs gold's 33 tokens. Q0774+Q0775
gold lengths (70+108 chars) were too short — model imitated example
length, losing recall.

This run swaps to Q0028 (123 chars, factoid: legal advisor appointments
count) + Q0024 (199 chars, explanation: technology plan submission).
Total 322 chars matches exp08's example total (~285 chars). Single-
variable change from exp12 — same held-out doc, same multi-turn chat
template, same 2-shot count; only the example pair differs.

If length-matching is the right diagnosis, exp13 should recover the
SS-score loss and beat exp12 by ~+0.005 composite, approaching exp08's
+0.0091 gain.
"""
...
FEW_SHOT = [
    {
        "query": (
            "จำนวนบุคคลที่คณะกรรมาธิการแต่งตั้งเป็นที่ปรึกษาประจำ"
            "คณะอนุกรรมาธิการศึกษาการปฏิรูป ทบทวน และแก้ไขปรับปรุงกฎหมาย"
            "มีจำนวนเท่าใด"
        ),
        "paragraph": (
            "ที่ประชุมได้พิจารณาและมีมติแต่งตั้งที่ปรึกษาประจำ"
            "คณะอนุกรรมาธิการศึกษาการปฏิรูป ทบทวนและแก้ไขปรับปรุงกฎหมาย "
            "(เพิ่มเติม) จำนวน ๔ คน"
        ),
        "answer": (
            "คณะกรรมาธิการแต่งตั้งบุคคลจำนวน 4 คน "
            "เป็นที่ปรึกษาประจำคณะอนุกรรมาธิการศึกษาการปฏิรูป ทบทวน "
            "และแก้ไขปรับปรุงกฎหมายเพิ่มเติม"
        ),
    },
    {
        "query": "แผนพัฒนาระบบเทคโนโลยีสารสนเทศประวัติอาชญากรรมได้มีการเสนอไปยังคณะรัฐมนตรีหรือไม่",
        "paragraph": (
            "นางสาวศรีญาดา ปาลิมาพันธ์ ที่ปรึกษาคณะกรรมาธิการ "
            "ได้กล่าวแสดงความเห็นว่า สำนักงานตำรวจแห่งชาติ ได้มีการเสนอแผน"
            "และวางแผนเกี่ยวกับการพัฒนาระบบเทคโนโลยีสารสนเทศ"
            "เกี่ยวกับประวัติอาชญากรรม เนื่องจากเรื่องดังกล่าว"
            "มีผลต่อการดำเนินชีวิตของประชาชน ได้มีการเสนอเรื่องดังกล่าว"
            "ไปยังคณะรัฐมนตรี"
        ),
        "answer": (
            "แผนพัฒนาระบบเทคโนโลยีสารสนเทศเกี่ยวกับประวัติอาชญากรรม"
            "ได้มีการเสนอไปยังคณะรัฐมนตรีแล้ว โดยสำนักงานตำรวจแห่งชาติ"
            "ได้วางแผนและให้ความสำคัญกับเรื่องดังกล่าว "
            "เนื่องจากส่งผลกระทบต่อการดำเนินชีวิตของประชาชน"
        ),
    },
]
