"""
exp61 — exp42 full train eval with prompt_lab V13_factual_extract.
...
Only the user prompt wording is changed to prompt_lab V13_factual_extract.

Decision rule: compare full and leak-free train metrics against exp42 to see
whether the R3 V13 prompt improvement on the 100-query prompt lab transfers to
...
def main():
    ...
    n = len(queries)
    print(f"exp61: {n} queries, {len(doc_index)} docs "
