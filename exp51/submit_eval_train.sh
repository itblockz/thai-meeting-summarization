...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp51_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp51_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp51/eval_result"
...
echo "=== exp51: Qwen3.6-27B-FP8 (single A100-40GB) + exp38 prompt/shots ==="
cd "$PROJECT/exp51"
python3 run.py

echo "=== exp51: scoring (full 1239, headline — has doc_050 few-shot leak) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp51: leak-free scoring (hold out doc_050, 1218 queries) ==="
