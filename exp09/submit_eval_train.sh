...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp09_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp09_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp09/eval_result"
...
echo "=== exp09: 1-shot (Example 1 only), held-out doc_050 ==="
cd "$PROJECT/exp09"
python3 run.py
