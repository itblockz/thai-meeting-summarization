...
echo "=== exp71: gemma-4-31B-it-FP8-Dynamic (single A100-40GB) + exp51 prompt/shots ==="
cd "$PROJECT/exp71"
python3 run.py

echo "=== exp71: scoring (full 1239, headline — has doc_050 few-shot leak) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp71: leak-free scoring (hold out doc_050, 1218 queries) ==="
