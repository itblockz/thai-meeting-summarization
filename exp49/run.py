"""
exp49 — model swap: Qwen3-32B-AWQ → Qwen3.6-27B-FP8 (single A100-40GB).

Multi-variable change from exp39 (prev best 0.6991): swap the LLM from
Qwen3-32B-AWQ (dense, AWQ-Marlin 4-bit) to **Qwen/Qwen3.5-27B-FP8**
...
Decision rule: accept exp49 if leak-free composite >= exp39 (0.6991).
...
MODEL_NAME     = os.environ.get("LLM_MODEL", "Qwen/Qwen3.5-27B-FP8")
...
def main():
    ...
    n = len(queries)
    print(f"exp49: {n} queries, {len(doc_index)} docs "
