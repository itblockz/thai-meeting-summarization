...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp03_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp03_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp03/eval_result"
...
echo "=== exp03: inference on train set ==="
cd "$PROJECT/exp03"
python3 run.py
