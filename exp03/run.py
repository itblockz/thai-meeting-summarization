"""
exp03 — textsum rerank pipeline + Qwen3-32B-AWQ.

Single change vs the textsum pipeline (exp01): the generation LLM is
Qwen3-32B-AWQ (no-think) instead of Qwen2.5-7B. Retrieval (dense + BM25
pool, cross-encoder rerank, top-1) is identical, so the score delta is
attributable to the LLM swap alone.
"""
