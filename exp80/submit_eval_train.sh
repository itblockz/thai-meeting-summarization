...
echo "=== exp80: pipeline 2 — Stage A=gemma-4-26B-A4B-FP8 refs, A3B writes answer, refs fixed ==="
cd "$PROJECT/exp80"
python3 run.py

echo "=== exp80: scoring (full 1239) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp80: leak-free scoring (excl. doc_050) ==="
