...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp84_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp84_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp84/eval_result"
...
echo "=== exp84: S1=A3B -> S2=gemma (hint=answer+ref), emit 4 combos ==="
cd "$PROJECT/exp84"
python3 run.py
