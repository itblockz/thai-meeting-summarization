"""
exp10 — 3-shot variant of exp08. Adds Q0757 (bsy. capital sources, long
list-style gold ~324 chars) to exp08's two examples. Q0757 is the highest
exp03 RougeL among doc_050 single-ref non-used queries (rl=0.588), so it
should anchor a "canonical" style for longer answers — the regime where
exp06 lost most (long-gold queries Δ=-0.02 to -0.03 vs exp03).
"""
