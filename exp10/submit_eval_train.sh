...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp10_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp10_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp10/eval_result"
...
echo "=== exp10: 3-shot (exp08 + Q0757), held-out doc_050 ==="
cd "$PROJECT/exp10"
python3 run.py
