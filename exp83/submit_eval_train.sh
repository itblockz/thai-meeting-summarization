...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp83_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp83_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp83/eval_result"
...
echo "=== exp83: answer-first — A3B writes answer, gemma re-answers+cites (answer discarded) ==="
cd "$PROJECT/exp83"
python3 run.py
