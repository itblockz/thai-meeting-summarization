...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp58_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp58_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp58/eval_result"
...
echo "=== exp58: pipeline 1 — exp50 refs filter, exp51 A3B writes answer ==="
cd "$PROJECT/exp58"
python3 run.py

echo "=== exp58: scoring (full 1239) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp58: leak-free scoring (excl. doc_050) ==="
