...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp72_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp72_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp72/eval_result"
...
export TP_SIZE="1"
export LLM_MODEL="RedHatAI/gemma-4-31B-it-FP8-block"
...
echo "=== exp72: gemma-4-31B-it-FP8-block (single A100-40GB) + exp51 prompt/shots ==="
cd "$PROJECT/exp72"
python3 run.py

echo "=== exp72: scoring (full 1239, headline — has doc_050 few-shot leak) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp72: leak-free scoring (hold out doc_050, 1218 queries) ==="
