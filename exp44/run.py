"""
exp44 — model swap: Qwen3-32B-AWQ → Qwen3.6-27B-FP8 (single A100-40GB).
...
Decision rule: accept exp44 if leak-free composite >= exp39 (0.6991).
...
def main():
    ...
    n = len(queries)
    print(f"exp44: {n} queries, {len(doc_index)} docs "
