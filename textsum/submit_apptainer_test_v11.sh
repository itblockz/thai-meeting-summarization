...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/v11_test_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/v11_test_%j.err
...
RESULT="$PROJECT/textsum_v11_test_result"
...
echo "=== testing v11_local SIF — E5 self-citation + 2-shot few-shot + vLLM + Qwen3-32B-AWQ ==="
