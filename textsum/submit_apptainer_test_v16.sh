...
# v16 = exp42 port: Qwen3-30B-A3B-Instruct-2507-FP8 in place of v15-K's
# Qwen3-32B-AWQ. Same prompt (exp38 wording) / shots / retrieval (none)
# — single-variable model swap. Leak-free venv composite: 0.7087
# (+0.010 vs v15-K). (exp51 was a parallel experiment with revised
# prompt wording → 0.7110; v16 image carries exp42's prompt, not
# exp51's.)
#
...
echo "=== v16 exp42 port (Qwen3-30B-A3B-FP8) container test ==="
