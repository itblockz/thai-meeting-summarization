#!/bin/bash
#SBATCH --job-name=v15_train_eval
...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/v15_train_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/v15_train_eval_%j.err
...
RESULT="$PROJECT/textsum_v15_train_eval_result"
