...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp56_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp56_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp56/eval_result"
...
echo "=== exp56: pipeline 2 — full context + hint from exp50 refs, refs fixed ==="
cd "$PROJECT/exp56"
python3 run.py

echo "=== exp56: scoring (full 1239) ==="
python3 "$PROJECT/textsum/eval_train/score.py" "$RESULT_DIR/submission.csv"

echo "=== exp56: leak-free scoring (excl. doc_050) ==="
