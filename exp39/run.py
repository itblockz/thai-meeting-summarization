"""
exp39 — MAX_NEW_TOKENS 512 → 1024 (rescue truncated long-answer queries).
...
Decision rule: accept exp39 if leak-free composite >= exp38 (0.6987).
...
MAX_NEW_TOKENS = 1024  # exp39 bump from 512
...
def main():
    ...
    n = len(queries)
    print(f"exp39: {n} queries, {len(doc_index)} docs "
