...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp11_eval_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/ua047/logs/exp11_eval_%j.err
...
export RESULT_DIR="$PROJECT/exp11/eval_result"
...
echo "=== exp11: 4-shot (exp10 + Q0756), held-out doc_050 ==="
cd "$PROJECT/exp11"
python3 run.py
