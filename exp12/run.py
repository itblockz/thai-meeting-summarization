"""
exp12 — doc_002 held-out validation of exp08 (2-shot prompt-fix).

exp08 ran with doc_050 held out and beat exp03 by +0.0091 composite.
This run repeats the same recipe with a different held-out doc
(doc_002 — middle-ground stats: gold_med 298 chars vs global 175,
single-ref 71% vs global ~70%, exp03 median rougeL 0.406). If the
+0.0091 gain is real and not doc-specific, exp12 should show a
similar Δ vs an apples-to-apples exp03 baseline on the 1218 queries
that exclude doc_002.

Examples drawn from doc_002 (Q0774 short factoid + Q0775 medium
explanation, matching exp08's structural pattern). Different source
paragraphs (P73 vs P76) to avoid example coupling.
"""
...
FEW_SHOT = [
    {
        "query": "โครงการ POLIS คือระบบฐานข้อมูลเกี่ยวกับอะไร",
        "paragraph": (
            "ระบบดังกล่าวพัฒนาขึ้นเพื่อบริหารจัดการในการอำนวยความสะดวกให้กับ"
            "ประชาชน รวมทั้งใช้สำหรับการติดตามผู้ต้องหาตามหมายจับ "
            "และการวิเคราะห์ข้อมูลในเรื่องต่าง ๆ ที่เกี่ยวข้อง "
            "รวมทั้งได้มีระบบฐานข้อมูลกำลังพล โครงการ POLIS "
            "เพื่อบันทึกและรายงานข้อมูลสถานภาพและอัตรากำลังพลและพัสดุของ"
            "สำนักงานตำรวจแห่งชาติ"
        ),
        "answer": (
            "โครงการ POLIS เป็นระบบฐานข้อมูลกำลังพลและพัสดุ"
            "ของสำนักงานตำรวจแห่งชาติ"
        ),
    },
    {
        "query": "ข้อสังเกตของคณะกรรมาธิการเกี่ยวกับระบบเทคโนโลยีสารสนเทศคืออะไร",
        "paragraph": (
            "นายประยุทธ์ ศิริพานิชย์ ที่ปรึกษาคณะกรรมาธิการ "
            "ได้กล่าวแสดงความเห็นว่า ระบบเทคโนโลยีสารสนเทศของ"
            "สำนักงานตำรวจแห่งชาติที่ใช้ในปัจจุบัน "
            "ยังขาดเครื่องมือที่ทันสมัยในการเชื่อมโยงข้อมูล"
            "ระหว่างหน่วยงานต่าง ๆ ได้อย่างสมบูรณ์ "
            "เห็นควรให้มีการจัดสรรงบประมาณสนับสนุนการพัฒนา"
            "ระบบเทคโนโลยีสารสนเทศให้มีเครื่องมือที่ทันสมัย"
        ),
        "answer": (
            "คณะกรรมาธิการให้ข้อสังเกตว่า ระบบเทคโนโลยีสารสนเทศ"
            "ยังขาดเครื่องมือทันสมัยในการเชื่อมโยงข้อมูลระหว่างหน่วยงาน"
        ),
    },
]
